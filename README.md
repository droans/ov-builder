...
| OPENVINO_GIT_REMOTE        | str  | Remote repo to use for the OV source                                     | 1       |      |
| OPENVINO_GIT_BRANCH        | str  | Branch to use for the OV source                                          | 1       | 2    |
| OPENVINO_GIT_PR            | int  | PR to use for the OV source                                              | 1       | 2    |
| OPENVINO_GIT_PR_USE_MERGED | int  | Whether to merge PR with master or use current head for the OV source    | 1       |      |
| OPENVINO_BUILD_TYPE        | str  | Build type to use for OpenVINO                                           | 1       | 1,3  |
| OPENVINO_BUILD_FILE        | str  | Build script to use for OpenVINO                                         | 1       | 1,3  |
| UPDATE_GENAI               | int  | Update GenAI (1: Update, 0: Skip)                                        | 1       |      |
| GENAI_GIT_REMOTE           | str  | Remote repo to use for the GenAI source                                  | 1       |      |
| GENAI_GIT_BRANCH           | str  | Branch to use for the GenAI source                                       | 1       | 2    |
| GENAI_GIT_PR               | int  | PR to use for the GenAI source                                           | 1       | 2    |
...
| OUTPUT_DIR                 | str  | Container directory to save wheels                                       | 1       |      |
